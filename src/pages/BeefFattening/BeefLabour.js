...
const BeefLabour = () => {
    ...
    const getData = () => {
      axios.get('http://68.178.163.174:5010/cattles/beef_labour').then(res => {
        setData(res.data)
      })
    }
    ...
    const addData = (e) => {
      ...
      axios.post('http://68.178.163.174:5010/cattles/beef_labour/add', {
        shed_id,
        name,
      }).then(res => {
        toast('Submitted')
    ...
    const editData = (e, id) => {
      ...
      axios.put(`http://68.178.163.174:5010/cattles/beef_labour/edit?id=${id}`, {
    ...
    const deleteData = (e,id) => {
      ...
      if(window.confirm('Do you want to delete this?')){
        axios.delete(`http://68.178.163.174:5010/cattles/beef_labour/delete?id=${id}`)
        .then(res => {
          toast('Deleted')
          getData()
              ...
              <div className="col-lg-6">
                <div className="d-flex align-items-center justify-content-center">
                  <a href="index.html" className="navbar-brand ms-lg-5">
                    <h1 className="m-2 display-4 text-success2"><span className="text-success2">Cattle</span> Labour</h1>
                  </a>
                </div>
              </div>
