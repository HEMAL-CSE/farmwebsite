...
const Calf_doctors = () => {
    ...
    const addData = (e) => {
      ...
      axios.post('http://68.178.163.174:5010/calf/doctors/add', {
        doctor_id,
        farm_id
      }).then(res => {
        toast('Submitted')
    ...
    const editData = (e, id) => {
      ...
      axios.put(`http://68.178.163.174:5010/calf/doctors/edit?id=${id}`, {
    ...
    const deleteData = (e,id) => {
      ...
      if(window.confirm('Do you want to delete this?')){
        axios.delete(`http://68.178.163.174:5010/calf/doctors/delete?id=${id}`)
        .then(res => {
          toast('Deleted')
          getData()
