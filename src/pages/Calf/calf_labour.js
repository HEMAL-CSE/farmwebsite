...
const CalfLabour = () => {
    ...
    const getData = () => {
      axios.get('http://68.178.163.174:5010/calf/calf_labour').then(res => {
        setData(res.data)
      })
    }
    ...
    const addData = (e) => {
      ...
      axios.post('http://68.178.163.174:5010/calf/calf_labour/add', {
        shed_id,
        name,
      }).then(res => {
        toast('Submitted')
    ...
    const editData = (e, id) => {
      ...
      axios.put(`http://68.178.163.174:5010/calf/calf_labour/edit?id=${id}`, {
    ...
    const deleteData = (e,id) => {
      ...
      if(window.confirm('Do you want to delete this?')){
        axios.delete(`http://68.178.163.174:5010/calf/calf_labour/delete?id=${id}`)
        .then(res => {
          toast('Deleted')
          getData()
