...
const BiogasSelling = () => {
  ...
  const getData = () => {
    axios.get('http://68.178.163.174:5010/biogas/income').then(res => {
      setData(res.data)
    })
  }
  ...
  const getCustomers = () => {
    axios.get(`http://68.178.163.174:5010/biogas/customer`)
      .then(res => {
  ...
  const addData = (e) => {
    ...
    axios.post('http://68.178.163.174:5010/biogas/income/add', {
      customer_id,
      income
    }).then(res => {
      toast('Submitted')
  ...
  const editData = (e, id) => {
    ...
    axios.put(`http://68.178.163.174:5010/biogas/income/edit?id=${id}`, {
  ...
  const deleteData = (e, id) => {
    ...
    if (window.confirm('Do you want to delete this?')) {
      axios.delete(`http://68.178.163.174:5010/biogas/income/delete?id=${id}`)
        .then(res => {
          toast('Deleted')
          getData()
