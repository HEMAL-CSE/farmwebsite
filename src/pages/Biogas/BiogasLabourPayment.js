...
const BiogasLabourPayment = () => {
    ...
    const [payment, setPayment] = useState('')
      ...
      const getData = () => {
        axios.get('http://68.178.163.174:5008/biogas/labour_payment').then(res => {
          setData(res.data)
        })
      }
      ...
      const getLabours = () => {
        axios.get(`http://68.178.163.174:5008/biogas/labour`)
        .then(res => {
          setLabours(res.data)
        })
      }
      ...
      const addData = (e) => {
        ...
        axios.post('http://68.178.163.174:5008/biogas/labour_payment/add', {
          labour_id,
          payment
        }).then(res => {
          toast('Submitted')
      ...
      const editData = (e, id) => {
        ...
        axios.put(`http://68.178.163.174:5008/biogas/labour_payment/edit?id=${id}`, {
      ...
      const deleteData = (e,id) => {
        ...
        if(window.confirm('Do you want to delete this?')){
          axios.delete(`http://68.178.163.174:5008/biogas/labour_payment/delete?id=${id}`)
          .then(res => {
            toast('Deleted')
            getData()
