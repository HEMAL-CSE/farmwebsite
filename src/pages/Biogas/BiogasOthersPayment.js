...
const BiogasOthersPayment = () => {
    ...
    const getData = () => {
        axios.get('http://68.178.163.174:5010/biogas/others_payment').then(res => {
            setData(res.data)
        })
    }
    ...
    const getOthers = () => {
        axios.get(`http://68.178.163.174:5010/biogas/others`)
            .then(res => {
                setOthers(res.data)
            })
    }
    ...
    const addData = (e) => {
        ...
        axios.post('http://68.178.163.174:5010/biogas/others_payment/add', {
            others_id: other,
            payment: amount,
        }).then(res => {
            toast('Submitted')
    ...
    const editData = (e, id) => {
        ...
        axios.put(`http://68.178.163.174:5010/biogas/others_payment/edit?id=${id}`, {
    ...
    const deleteData = (e, id) => {
        ...
        if (window.confirm('Do you want to delete this?')) {
            axios.delete(`http://68.178.163.174:5010/biogas/others_payment/delete?id=${id}`)
                .then(res => {
                    toast('Deleted')
                    getData()
