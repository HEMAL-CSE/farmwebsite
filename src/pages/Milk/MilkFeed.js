...
const MilkFeed = () => {
    ...
    const getData = () => {
      axios.get('http://68.178.163.174:5010/dairy/expenses/feed').then(res => {
        setData(res.data)
      })
    }
    ...
    const addData = (e) => {
      ...
      axios.post('http://68.178.163.174:5010/dairy/expenses/feed/add', {
        shed_id,
        seat_id,
        cow_id,
        amount,
    ...
    const editData = (e, id) => {
      ...
      axios.put(`http://68.178.163.174:5010/dairy/expenses/feed/edit?id=${id}`, {
    ...
    const deleteData = (e,id) => {
      ...
      if(window.confirm('Do you want to delete this?')){
        axios.delete(`http://68.178.163.174:5010/dairy/expenses/feed/delete?id=${id}`)
        .then(res => {
          toast('Deleted')
          getData()
          ...
          <div className="col-lg-6">
            <div className="d-flex align-items-center justify-content-center">
              <a href="index.html" className="navbar-brand ms-lg-5">
                <h1 className="m-2 display-4 text-success2"><span className="text-success2">Dairy</span> Feed</h1>
              </a>
            </div>
          </div>
