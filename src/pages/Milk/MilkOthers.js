...
const MilkOthers = () => {
    ...
    const getData = () => {
        axios.get('http://68.178.163.174:5010/dairy/expenses/othe').then(res => {
            setData(res.data)
        })
    }
    ...
    const addData = (e) => {
        ...
        axios.post('http://68.178.163.174:5010/dairy/expenses/other/add', {
            name,
    ...
    const editData = (e, id) => {
        ...
        axios.put(`http://68.178.163.174:5010/dairy/expenses/other/edit?id=${id}`, {
            name: edit_name,
    ...
    const deleteData = (e, id) => {
        ...
        if (window.confirm('Do you want to delete this?')) {
            axios.delete(`http://68.178.163.174:5010/dairy/expenses/other/delete?id=${id}`)
                .then(res => {
                    toast('Deleted')
                    getData()
