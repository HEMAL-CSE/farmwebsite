...
const MilkDoctors = () => {
    ...
    const addData = (e) => {
      ...
      axios.post('http://68.178.163.174:5010/doctors/approved', {
        doctor_id,
        farm_id
      }).then(res => {
      getData()
    ...
    const editData = (e, id) => {
      ...
      axios.put(`http://68.178.163.174:5010/dairy/doctors/edit?id=${id}`, {
    ...
    const deleteData = (e,id) => {
      ...
      if(window.confirm('Do you want to delete this?')){
        axios.delete(`http://68.178.163.174:5010/dairy/doctors/delete?id=${id}`)
        .then(res => {
          toast('Deleted')
          getData()
