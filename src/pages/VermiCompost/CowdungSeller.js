...
const CowdungSeller = () => {
    ...
    const getData = () => {
        axios.get('http://68.178.163.174:5010/vermi_compost/cowdung_seller').then(res => {
            setData(res.data)
        })
    }
    ...
    const addData = (e) => {
        ...
        axios.post('http://68.178.163.174:5010/vermi_compost/cowdung_seller/add', {
            seller_id: id,
            name,
            address,
            mobile_no,
    ...
    const editData = (e, id) => {
        ...
        axios.put(`http://68.178.163.174:5010/vermi_compost/cowdung_seller/edit?seller_id=${id}`, {
            name: edit_name,
    ...
    const deleteData = (e, id) => {
        ...
        if (window.confirm('Do you want to delete this?')) {
            axios.delete(`http://68.178.163.174:5010/vermi_compost/cowdung_seller/delete?seller_id=${id}`)
                .then(res => {
                    toast('Deleted')
                    getData()
                        ...
                        <div className="col-lg-6">
                            <div className="d-flex align-items-center justify-content-center">
                                <a href="index.html" className="navbar-brand ms-lg-5">
                                    <h1 className="m-2 display-4 text-success2"><span className="text-success2">Cowdung</span> Seller</h1>
                                </a>
                            </div>
                        </div>
