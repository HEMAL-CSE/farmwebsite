...
const CowdungOthersPayment = () => {
    ...
    const getData = () => {
        axios.get('http://68.178.163.174:5010/vermi_compost/others_payment').then(res => {
            setData(res.data)
        })
    }
    ...
    useEffect(() => {
        ...
        axios.get(`http://68.178.163.174:5010/vermi_compost/others_list`)
            .then(res => {
                setOthers(res.data)
            })
    ...
    const addData = (e) => {
        ...
        axios.post('http://68.178.163.174:5010/vermi_compost/others_payment/add', {
            others_id: others,
            amount,
            date,
        }).then(res => {
    ...
    const editData = (e, id) => {
        ...
        axios.put(`http://68.178.163.174:5010/vermi_compost/others_payment/edit?id=${id}`, {
    ...
    const deleteData = (e, id) => {
        ...
        if (window.confirm('Do you want to delete this?')) {
            axios.delete(`http://68.178.163.174:5010/vermi_compost/others_payment/delete?id=${id}`)
                .then(res => {
                    toast('Deleted')
                    getData()
...
export default CowdungOthersPayment