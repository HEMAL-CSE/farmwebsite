...
const EarthwormProd = () => {
    ...
    const getData = () => {
        axios.get('http://68.178.163.174:5010/vermi_compost/earthworm_prod').then(res => {
            setData(res.data)
        })
    }
    ...
    const addData = (e) => {
        ...
        axios.post('http://68.178.163.174:5010/vermi_compost/earthworm_prod/add', {
            amount: kg,
            date
        }).then(res => {
            toast('Submitted')
    ...
    const editData = (e, id) => {
        ...
        axios.put(`http://68.178.163.174:5010/vermi_compost/earthworm_prod/edit?id=${id}`, {
            amount: editkg,
            date: editDate,
        })
            .then(res => {
    ...
    const deleteData = (e, id) => {
        ...
        if (window.confirm('Do you want to delete this?')) {
            axios.delete(`http://68.178.163.174:5010/vermi_compost/earthworm_prod/delete?id=${id}`)
                .then(res => {
                    toast('Deleted')
                    getData()
                        ...
                        <div className="col-lg-6">
                            <div className="d-flex align-items-center justify-content-center">
                                <a href="index.html" className="navbar-brand ms-lg-5">
                                    <h1 className="m-2 display-4 text-success2"><span className="text-success2">Production</span> Details</h1>
                                </a>
                            </div>
                        </div>
