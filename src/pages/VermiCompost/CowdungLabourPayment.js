...
const CowdungLabourPayment = () => {
    ...
    const getData = () => {
        axios.get('http://68.178.163.174:5010/vermi_compost/labour_payment').then(res => {
            setData(res.data)
        })
    }
    ...
    useEffect(() => {
        ...
        axios.get(`http://68.178.163.174:5010/vermi_compost/labour_list`)
            .then(res => {
                setLabours(res.data)
            })
    ...
    const addData = (e) => {
        ...
        axios.post('http://68.178.163.174:5010/vermi_compost/labour_payment/add', {
            labour_id: labour,
            amount,
            date,
        }).then(res => {
    ...
    const editData = (e, id) => {
        ...
        axios.put(`http://68.178.163.174:5010/vermi_compost/labour_payment/edit?id=${id}`, {
    ...
    const deleteData = (e, id) => {
        ...
        if (window.confirm('Do you want to delete this?')) {
            axios.delete(`http://68.178.163.174:5010/vermi_compost/labour_payment/delete?id=${id}`)
                .then(res => {
                    toast('Deleted')
                    getData()
                        ...
                        <div className="col-lg-6">
                            <div className="d-flex align-items-center justify-content-center">
                                <a href="index.html" className="navbar-brand ms-lg-5">
                                    <h1 className="m-2 display-4 text-success2"><span className="text-success2">Labour</span> Payment</h1>
                                </a>
                            </div>
                        </div>
...
export default CowdungLabourPayment