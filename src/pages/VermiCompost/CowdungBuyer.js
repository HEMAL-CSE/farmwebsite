...
const CowdungBuyer = () => {
    ...
    const getData = () => {
        axios.get('http://68.178.163.174:5010/vermi_compost/cowdung_purchase').then(res => {
            setData(res.data)
        })
    }
    ...
    useEffect(() => {
        ...
        axios.get(`http://68.178.163.174:5010/vermi_compost/cowdung_seller`)
            .then(res => {
                setSellers(res.data)
            })
    ...
    const addData = (e) => {
        ...
        axios.post('http://68.178.163.174:5010/vermi_compost/cowdung_purchase/add', {
            seller_id: seller,
            amount: kg,
            date,
            rate_per_kg: rate,
    ...
    const editData = (e, id) => {
        ...
        axios.put(`http://68.178.163.174:5010/vermi_compost/cowdung_purchase/edit?id=${id}`, {
    ...
    const deleteData = (e, id) => {
        ...
        if (window.confirm('Do you want to delete this?')) {
            axios.delete(`http://68.178.163.174:5010/vermi_compost/cowdung_purchase/delete?id=${id}`)
                .then(res => {
                    toast('Deleted')
                    getData()
                        ...
                        <div className="col-lg-6">
                            <div className="d-flex align-items-center justify-content-center">
                                <a href="index.html" className="navbar-brand ms-lg-5">
                                    <h1 className="m-2 display-4 text-success2"><span className="text-success2">Cowdung</span> Buyer</h1>
                                </a>
                            </div>
                        </div>
