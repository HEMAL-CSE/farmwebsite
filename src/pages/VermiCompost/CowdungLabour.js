...
const CowdungLabour = () => {
    ...
    const getData = () => {
        axios.get('http://68.178.163.174:5010/vermi_compost/labour_list').then(res => {
            setData(res.data)
        })
    }
    ...
    const addData = (e) => {
        ...
        axios.post('http://68.178.163.174:5010/vermi_compost/labour_list/add', {
            name,
            amount,
            date,
            salary_status,
    ...
    const editData = (e, id) => {
        ...
        axios.put(`http://68.178.163.174:5010/vermi_compost/labour_list/edit?id=${id}`, {
            name: edit_name,
            amount: edit_amount,
            date: edit_date,
    ...
    const deleteData = (e, id) => {
        ...
        if (window.confirm('Do you want to delete this?')) {
            axios.delete(`http://68.178.163.174:5010/vermi_compost/labour_list/delete?id=${id}`)
                .then(res => {
                    toast('Deleted')
                    getData()
                        ...
                        <div className="col-lg-6">
                            <div className="d-flex align-items-center justify-content-center">
                                <a href="index.html" className="navbar-brand ms-lg-5">
                                    <h1 className="m-2 display-4 text-success2"><span className="text-success2">Labour</span> List</h1>
                                </a>
                            </div>
                        </div>
