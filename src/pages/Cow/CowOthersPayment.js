...
const CowOthersPayment = () => {
    ...
    const getData = () => {
        axios.get('http://68.178.163.174:5010/breeding/breeding_others_payment').then(res => {
            setData(res.data)
        })
    }
    ...
    const getOthers = (shed_id, seat_id) => {
        axios.get(`http://68.178.163.174:5010/breeding/breeding_others?shed_id=${shed_id}&seat_id=${seat_id}`)
            .then(res => {
                setOthers(res.data)
            })
    }
    ...
    const addData = (e) => {
        ...
        axios.post('http://68.178.163.174:5010/breeding/breeding_others_payment/add', {
            others_id: other,
            shed_id,
            seat_id,
            payment: amount,
    ...
    const editData = (e, id) => {
        ...
        axios.put(`http://68.178.163.174:5010/breeding/breeding_others_payment/edit?id=${id}`, {
    ...
    const deleteData = (e, id) => {
        ...
        if (window.confirm('Do you want to delete this?')) {
            axios.delete(`http://68.178.163.174:5010/breeding/breeding_others_payment/delete?id=${id}`)
                .then(res => {
                    toast('Deleted')
                    getData()
...
export default CowOthersPayment