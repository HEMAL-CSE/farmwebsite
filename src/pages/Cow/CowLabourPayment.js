...
const CowLabourPayment = () => {
    ...
    const [payment, setPayment] = useState('')
      ...
      const getData = () => {
        axios.get('http://68.178.163.174:5010/breeding/breeding_labour_payment').then(res => {
          setData(res.data)
        })
      }
      ...
      const getLabours = (shed_id) => {
        axios.get(`http://68.178.163.174:5010/breeding/breeding_labour?shed_id=${shed_id}`)
        .then(res => {
          setLabours(res.data)
        })
      }
      ...
      const addData = (e) => {
        ...
        axios.post('http://68.178.163.174:5010/breeding/breeding_labour_payment/add', {
          shed_id,
          labour_id,
          payment
        }).then(res => {
      ...
      const editData = (e, id) => {
        ...
        axios.put(`http://68.178.163.174:5010/breeding/breeding_labour_payment/edit?id=${id}`, {
      ...
      const deleteData = (e,id) => {
        ...
        if(window.confirm('Do you want to delete this?')){
          axios.delete(`http://68.178.163.174:5010/breeding/breeding_labour_payment/delete?id=${id}`)
          .then(res => {
            toast('Deleted')
            getData()
                ...
                <div className="col-lg-6">
                  <div className="d-flex align-items-center justify-content-center">
                    <a href="index.html" className="navbar-brand ms-lg-5">
                      <h1 className="m-2 display-4 text-success2"><span className="text-success2">Cow</span> Labour Payment</h1>
                    </a>
                  </div>
                </div>
...
export default CowLabourPayment