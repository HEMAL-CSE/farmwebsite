...
const CowOthers = () => {
    ...
    const getData = () => {
        axios.get('http://68.178.163.174:5010/breeding/breeding_others').then(res => {
            setData(res.data)
        })
    }
    ...
    const addData = (e) => {
        ...
        axios.post('http://68.178.163.174:5010/breeding/breeding_others/add', {
            shed_id,
            seat_id,
            name,
    ...
    const editData = (e, id) => {
        ...
        axios.put(`http://68.178.163.174:5010/breeding/breeding_others/edit?id=${id}`, {
            name: edit_name,
    ...
    const deleteData = (e, id) => {
        ...
        if (window.confirm('Do you want to delete this?')) {
            axios.delete(`http://68.178.163.174:5010/breeding/breeding_others/delete?id=${id}`)
                .then(res => {
                    toast('Deleted')
                    getData()
