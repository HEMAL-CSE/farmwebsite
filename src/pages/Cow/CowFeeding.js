...
const CowFeeding = () => {
    ...
    const getData = () => {
        axios.get('http://68.178.163.174:5010/breeding/feed_names').then(res => {
            setData(res.data)
        })
    }
    ...
    const addData = (e) => {
        ...
        axios.post('http://68.178.163.174:5010/breeding/feed_names/add', {
            name,
        }).then(res => {
            toast('Submitted')
            getData()
    ...
    const editData = (e, id) => {
        ...
        axios.put(`http://68.178.163.174:5010/breeding/feed_names/edit?id=${id}`, {
            name: editName,
        })
            .then(res => {
                getData()
    ...
    const deleteData = (e, id) => {
        ...
        if (window.confirm('Do you want to delete this?')) {
            axios.delete(`http://68.178.163.174:5010/breeding/feed_names/delete?id=${id}`)
                .then(res => {
                    toast('Deleted')
                    getData()
